...
exports.Runner = (function() {
  ...
  Runner.prototype.loadFile = function(filename) {
    ...
    for (cls in _ref) {
      ...
      _results.push(func.isTwerpTest ? __bind(function(cls) {
        return this.tests[cls] = new func(null, null, __bind(function(res) {
          return this.results[cls] = res;
        }, this));
      }, this)(cls) : void 0);
    }
    return _results;
  ...
  Runner.prototype.run = function() {
    ...
    for (cls in _ref) {
      test = _ref[cls];
      _results.push(test.run(this.display));
    }
    return _results;
  };
  Runner.prototype.display = function(res) {
