...
exports.Runner = (function() {
  ...
  Runner.prototype.onFail = function(error) {};
  Runner.prototype.onStartTest = function(name) {};
  Runner.prototype.onStartClass = function(name) {};
  Runner.prototype.onStartFile = function(name) {};
  Runner.prototype.runClass = function(_arg) {
    ...
    obj.on("runTest", this.onStartTest);
