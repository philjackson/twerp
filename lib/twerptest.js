...
exports.TwerpTest = (function() {
  ...
  TwerpTest.prototype.gatherRunnables = function() {
    var func, prop, re, runnables, setup, setups, teardown, teardowns, _i, _j, _len, _len2;
    ...
    for (prop in this) {
      ...
      for (_i = 0, _len = setups.length; _i < _len; _i++) {
        setup = setups[_i];
        runnables.push([setup, false]);
      }
      runnables.push([prop, true]);
      for (_j = 0, _len2 = teardowns.length; _j < _len2; _j++) {
        teardown = teardowns[_j];
...
assert.isEmptyArray = function(array, message) {
  if (!array instanceof Array || array.length !== 0) {
    return this.fail(array, [], message, "[[Class]]");
  }
};