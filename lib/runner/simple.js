...
exports.Simple = (function() {
  ...
  Simple.prototype.onEndRun = function(all_results) {
    var results, test, _len, _results;
    _results = [];
    for (results = 0, _len = all_results.length; results < _len; results++) {
      test = all_results[results];
      _results.push(console.log(test));
    }
    return _results;
  };
  return Simple;
